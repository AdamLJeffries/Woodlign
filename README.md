...
How to Run it?
Use Microsoft VSCode and make sure to have Node installed. Then use VSCode's Live Server by clicking "Go Live". The page should launch. There are two APIs that will draw data and no key is required. All the links work and should redirect to other html pages.
...
It will also use a graph that visualizes data in a friendly way(Fun measured in awesome points.)